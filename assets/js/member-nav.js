...
(function () {
  ...
  var ICONES = {
    ...
    'formations-cms': 'M2.5 9 12 4.5 21.5 9 12 13.5zM6.5 11.2V16c0 1.2 2.5 2.4 5.5 2.4s5.5-1.2 5.5-2.4v-4.8',
...
(function () {
  ...
  barre.innerHTML =
    ...
    + '</form>'
    + '<div class="ms-outils">'
    // Retour au site public, present sur toutes les pages de l'espace.
